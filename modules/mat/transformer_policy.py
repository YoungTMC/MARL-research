import torch
import numpy as np
from tools.util import update_linear_schedule
from tools.util import get_shape_from_obs_space, get_shape_from_act_space
from modules.mat.utils.util import check
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["mat", "mat_dec"]:
            from modules.mat.ma_transformer import MultiAgentTransformer as MAT
        else:
